// =============================================================================
// SITEMAP DATA - MICROCEMENTO
// =============================================================================
// Microcemento en España - 8118 municipalities
// =============================================================================
...
// =============================================================================
// HIGH-INTENT KEYWORD MODIFIERS - Sector Microcemento
// =============================================================================
export const MODIFIERS = [
  ...
  // ============ URGENCIA / VELOCIDAD ============
  "-rapido", "-urgente", "-express",

  // ============ CALIDAD / REPUTACION ============
  "-mejor", "-calidad-precio", "-profesional", "-de-confianza",
  "-mejor-valorado", "-recomendado",

  // ============ TIPO DE SERVICIO ============
  "-llave-en-mano", "-integral", "-completo",
  "-sin-obras", "-sobre-azulejos",

  // ============ ESTILO ============
  "-moderno", "-minimalista", "-rustico", "-industrial",

  // ============ ACABADO ============
  "-efecto-piedra", "-efecto-madera", "-efecto-hormigon",
  "-mate", "-satinado", "-brillante",

  // ============ COLOR ============
  "-blanco", "-gris", "-negro", "-beige", "-arena",

  // ============ MATERIAL ============
  "-bicomponente", "-monocomponente",

  // ============ UBICACIÓN ============
  "-cerca-de-mi", "-centro",

  // ============ COMBOS ============
  "-economico-profesional", "-moderno-llave-en-mano",
] as const;
...
export const PROBLEMS: Record<Service, readonly string[]> = {
  "microcemento-suelos": [
    "suelo-viejo", "baldosas-feas", "suelo-irregular",
    "cambiar-suelo-sin-obras", "suelo-continuo", "suelo-sin-juntas",
  ],
  "microcemento-banos": [
    "bano-antiguo", "azulejos-feos", "humedad-bano",
    "reformar-bano-sin-obras", "plato-ducha-microcemento",
  ],
  "microcemento-cocinas": [
    "encimera-vieja", "cocina-anticuada", "renovar-cocina-sin-obras",
    "cocina-moderna",
  ],
  "microcemento-paredes": [
    "paredes-lisas", "revestimiento-paredes", "paredes-decorativas",
    "eliminar-gotel",
  ],
  "microcemento-exterior": [
    "terraza-exterior", "suelo-terraza", "fachada-exterior",
    "patio-exterior",
  ],
  "microcemento-piscinas": [
    "piscina-antigua", "revestimiento-piscina", "coronacion-piscina",
    "playa-piscina",
  ],
  "microcemento-escaleras": [
    "escaleras-antiguas", "revestir-escaleras", "escaleras-modernas",
    "peldanos-microcemento",
  ],
  "aplicador-microcemento": [
    "busco-aplicador", "aplicador-certificado", "profesional-microcemento",
    "empresa-microcemento",
  ],
  "microcemento-decorativo": [
    "pared-decorativa", "chimenea-microcemento", "mueble-microcemento",
    "isla-cocina-microcemento",
  ],
  "cemento-pulido": [
    "suelo-cemento-pulido", "hormigon-pulido", "acabado-industrial",
    "loft-cemento",
  ],
} as const;
